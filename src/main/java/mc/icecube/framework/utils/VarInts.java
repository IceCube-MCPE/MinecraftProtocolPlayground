...
public class VarInts {
    ...
    public static void writeUnsignedInt(ByteArrayOutputStream buffer, long value) throws IOException {
    ...
    private static void encodeFull(ByteArrayOutputStream out, long value) throws IOException {
        byte[] bytes;
